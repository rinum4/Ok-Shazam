...
class SqliteDatabase(Database):
  ...
  def insertMany(self, table, columns, values):
    ...
    for split_values in grouper(values, 1000):
      ...
      #query = "INSERT OR IGNORE INTO %s (%s) VALUES (%s, %s, %s)" % (table, ", ".join(columns),split_values[0][0], str(split_values[0][1]),split_values[0][2])
      #print(query, split_values)
      #print(query)
      #split_v = (1,'123456',2)
      #print(split_values[0].dtypes)
      #print(split_v)
      #self.cur.execute(query, split_v)
